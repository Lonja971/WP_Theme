...
<?php //get_header('page');  If we need header-page.php ?>
         ...
         <main class="page">
						...
						<div class="services__body">
							<div class="services__column">
								<div class="services__item item-service">
									<div class="item-service__icon servise__icon-1"></div>
							...
							<div class="services__column">
								<div class="services__item item-service">
									<div class="item-service__icon servise__icon-2"></div>
							...
							<div class="services__column">
								<div class="services__item item-service item-service_green">
									<div class="item-service__icon servise__icon-3"></div>
					...
					<div class="adventages__container __container">
						...
						<div class="adventages__body">
							<div class="adventages__column">
								<div class="adventages__item">
									<div class="adventages__icon">
										<img src="<?php echo(get_template_directory_uri()); ?>/img/advantages/01.svg" alt="">
									</div>
							...
							<div class="adventages__column">
								<div class="adventages__item">
									<div class="adventages__icon">
										<img src="<?php echo(get_template_directory_uri()); ?>/img/advantages/02.svg" alt="">
									</div>
							...
							<div class="adventages__column">
								<div class="adventages__item">
									<div class="adventages__icon">
										<img src="<?php echo(get_template_directory_uri()); ?>/img/advantages/03.svg" alt="">
									</div>
							...
							<div class="adventages__column">
								<div class="adventages__item">
									<div class="adventages__icon">
										<img src="<?php echo(get_template_directory_uri()); ?>/img/advantages/04.svg" alt="">
									</div>
									<div class="adventages__value">746 +</div>
				...
				<section class="page__practice practice">
					<div class="practice__container __container">
							...
							<div class="practice__column">
								<article class="practice__item item-practice">
									<div class="item-practice__content">
										...
										<div class="item-ptactice__text">
											Newton thought that light was made up of particles, but then it was discovered
										</div>
									</div>
									<a href="#" class="item-ptactice__image _ibg">
										<img src="<?php echo(get_template_directory_uri()); ?>/img/whoweare/media bg-cover.png" alt="">
									</a>
								</article>
							</div>
							<div class="practice__column">
				...
				<section class="page__whoweare whoweare">
					<div class="whoweare__container __container">
						...
						<div class="whoweare__body">
							<a href="#" class="whoweare__photo">
								<img src="<?php echo(get_template_directory_uri()); ?>/img/whoweare/media bg-cover.png" alt="">
								<img src="<?php echo(get_template_directory_uri()); ?>/img/whoweare/button.png" alt="">
							</a>
								...
								<div class="whoweare__items">
									<div class="whoweare__item item-whoweare">
										<div class="item-whoweare__icon">
											<img src="<?php echo(get_template_directory_uri()); ?>/img/whoweare/icons/01.svg" alt="">
										</div>
										<div class="item-whoweare__body">
											<div class="item-whoweare__title">the quick fox jumps over the lazy dog</div>
											<div class="item-whoweare__text">Things on a very small scale the quick fox jumps over the lazy dog</div>
										</div>
									</div>
									<div class="whoweare__item item-whoweare">
										<div class="item-whoweare__icon">
											<img src="<?php echo(get_template_directory_uri()); ?>/img/whoweare/icons/02.svg" alt="">
										</div>
										<div class="item-whoweare__body">
											<div class="item-whoweare__title">the quick fox jumps over the lazy dog</div>
											<div class="item-whoweare__text">Things on a very small scale the quick fox jumps over the lazy dog</div>
					...
					<div class="subscribe__container __container">
						<div class="subscribe__body">
							...
							<form action="#" class="subscribe__form">
								<input autocomplete="off" required type="email" placeholder="Your Email" name="form[]" class="subscribe__input">
						...
						<div class="getintouch__items">
							<div class="getintouch__item item-getintouch">
								<div class="item-getintouch__icon">
									<img src="<?php echo(get_template_directory_uri()); ?>/img/getintouch/01.svg" alt="">
								</div>
							...
							<div class="getintouch__item item-getintouch item-getintouch_active">
								<div class="item-getintouch__icon">
									<img src="<?php echo(get_template_directory_uri()); ?>/img/getintouch/02.svg" alt="">
								</div>
								<div class="item-getintouch__emails">
									<a href="mailto:georgia.young@example.com" class="item-getintouch__email">georgia.young@example.com</a>
									<a href="mailto:georgia.young@ple.com" class="item-getintouch__email">georgia.young@ple.com</a>
							...
							<div class="getintouch__item item-getintouch">
								<div class="item-getintouch__icon">
									<img src="<?php echo(get_template_directory_uri()); ?>/img/getintouch/03.svg" alt="">
								</div>
								<div class="item-getintouch__emails">
									<a href="mailto:georgia.young@example.com" class="item-getintouch__email">georgia.young@example.com</a>
									<a href="mailto:georgia.young@ple.com" class="item-getintouch__email">georgia.young@ple.com</a>
